...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(company-irony company-jedi irony-eldoc sicp outshine beacon pine-script-mode)
...
This function should only modify configuration layer settings."
  (setq-default
   ...
   ;; '(your-package :location "~/path/to/your-package/")
   ;; Also include the dependencies as they will not be resolved automatically.
   dotspacemacs-additional-packages '(company-irony company-jedi irony-eldoc sicp outshine beacon pine-script-mode polymode poly-R poly-noweb poly-markdown)
...
(use-package treemacs
 ...
 ;;
 ;;(load "~/.emacs.d/private/local/pretty-outlines.el")
 ;;
 ;;;; outshine
 ...
 ;;         (outline-minor-mode . outshine-hook-function)))
  ...
  (use-package ycmd
    ...
    (set-variable 'ycmd-server-command '("python3" "-u" "/usr/share/ycmd/ycmd"))
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yasnippet-snippets treemacs-projectile treemacs-evil treemacs pfuture slime-company slime racket-mode proof-general outshine org-ref pdf-tools org-download magithub lsp-ui lsp-java hlint-refactor hl-todo evil-visual-mark-mode evil-magit elm-mode reformatter ein editorconfig doom-modeline define-word cquery aggressive-indent ace-link ivy ess window-purpose imenu-list avy lsp-mode company projectile magit visual-fill-column zeal-at-point yapfify xterm-color x86-lookup ws-butler writeroom-mode winum which-key websocket web-mode web-beautify volatile-highlights vmd-mode vimrc-mode vi-tilde-fringe uuidgen utop use-package unfill twittering-mode tuareg toml-mode toc-org tide tagedit tablist symon string-inflection sql-indent spaceline-all-the-icons smex smeargle slim-mode sicp shrink-path shell-pop scss-mode sass-mode salt-mode rjsx-mode restclient-helm restart-emacs ranger rainbow-delimiters racer pyvenv pytest pyenv-mode py-isort pug-mode protobuf-mode prodigy prettier-js play-crystal plantuml-mode pippel pipenv pip-requirements persp-mode pcre2el password-generator paradox pandoc-mode ox-reveal ox-pandoc ox-gfm overseer outorg orgit org-projectile org-present org-pomodoro org-mime org-bullets org-brain open-junk-file ocp-indent ob-restclient ob-ipython ob-http ob-elixir ob-crystal ob-cfengine3 nim-mode neotree nasm-mode nameless mwim mvn multi-term mu4e-maildirs-extension mu4e-alert move-text meghanada maven-test-mode markdown-toc magit-svn magit-gitflow magit-gh-pulls macrostep lsp-go lorem-ipsum livid-mode live-py-mode link-hint key-chord julia-mode json-navigator json-mode js2-refactor js-doc irony-eldoc insert-shebang inf-crystal indent-guide importmagic impatient-mode idris-mode hungry-delete hindent highlight-parentheses highlight-numbers highlight-indentation helm-xref helm-themes helm-swoop helm-rtags helm-pydoc helm-purpose helm-projectile helm-pass helm-org-rifle helm-mu helm-mode-manager helm-make helm-hoogle helm-gitignore helm-git-grep helm-flx helm-descbinds helm-dash helm-css-scss helm-company helm-c-yasnippet helm-bibtex helm-ag haskell-snippets groovy-mode groovy-imports graphviz-dot-mode gradle-mode google-translate google-c-style golden-ratio godoctor go-tag go-rename go-impl go-guru go-gen-test go-fill-struct go-eldoc gnuplot gitignore-templates github-search github-clone gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe git-gutter-fringe+ gist ghub+ gh-md geiser geeknote fuzzy font-lock+ flycheck-ycmd flycheck-rust flycheck-rtags flycheck-pos-tip flycheck-ocaml flycheck-nim flycheck-mix flycheck-ledger flycheck-haskell flycheck-elm flycheck-crystal flycheck-credo flycheck-bashate flx-ido fish-mode fill-column-indicator fasd fancy-battery faceup eyebrowse expand-region evil-visualstar evil-unimpaired evil-tutor evil-surround evil-snipe evil-org evil-numbers evil-mc evil-matchit evil-lisp-state evil-lion evil-ledger evil-indent-plus evil-iedit-state evil-goggles evil-exchange evil-escape evil-ediff evil-commentary evil-cleverparens evil-args evil-anzu eval-sexp-fu ess-R-data-view eshell-z eshell-prompt-extras esh-help erlang ensime emmet-mode elm-test-runner elisp-slime-nav elfeed-web elfeed-org elfeed-goodies eldoc-eval dumb-jump dotenv-mode doom-themes disaster diminish diff-hl deft darktooth-theme dactyl-mode cython-mode csv-mode counsel-projectile company-ycmd company-web company-tern company-statistics company-shell company-rtags company-restclient company-lsp company-jedi company-irony company-go company-ghci company-emacs-eclim company-coq company-cabal company-c-headers company-auctex company-anaconda common-lisp-snippets column-enforce-mode cmm-mode clean-aindent-mode clang-format centered-cursor-mode ccls cargo browse-at-remote bm beacon auto-yasnippet auto-highlight-symbol auto-complete-rst auto-compile auctex-latexmk atom-one-dark-theme ameba alchemist adoc-mode ace-window ace-jump-helm-line ac-ispell))))
(custom-set-faces
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (zeal-at-point yasnippet-snippets yapfify xterm-color x86-lookup ws-butler writeroom-mode winum which-key web-mode web-beautify volatile-highlights vmd-mode vimrc-mode vi-tilde-fringe uuidgen utop use-package unfill twittering-mode tuareg treemacs-projectile treemacs-evil toml-mode toc-org tide tagedit symon string-inflection sql-indent spaceline-all-the-icons smex smeargle slime-company slim-mode sicp shell-pop scss-mode sass-mode salt-mode rjsx-mode restclient-helm restart-emacs ranger rainbow-delimiters racket-mode racer pyvenv pytest pyenv-mode py-isort pug-mode protobuf-mode proof-general prodigy prettier-js play-crystal plantuml-mode pippel pipenv pip-requirements pine-script-mode persp-mode pcre2el password-generator paradox pandoc-mode ox-reveal ox-pandoc ox-gfm overseer outshine orgit org-ref org-projectile org-present org-pomodoro org-mime org-download org-bullets org-brain open-junk-file ocp-indent ob-restclient ob-ipython ob-http ob-elixir ob-crystal ob-cfengine3 nim-mode nasm-mode nameless mwim mvn multi-term mu4e-maildirs-extension mu4e-alert move-text meghanada maven-test-mode markdown-toc magithub magit-svn magit-gitflow magit-gh-pulls lsp-ui lsp-java lsp-go lorem-ipsum livid-mode live-py-mode link-hint json-navigator json-mode js2-refactor js-doc irony-eldoc insert-shebang inf-crystal indent-guide importmagic impatient-mode idris-mode hungry-delete hlint-refactor hl-todo hindent highlight-parentheses highlight-numbers highlight-indentation helm-xref helm-themes helm-swoop helm-rtags helm-pydoc helm-purpose helm-projectile helm-pass helm-org-rifle helm-mu helm-mode-manager helm-make helm-hoogle helm-gitignore helm-git-grep helm-flx helm-descbinds helm-dash helm-css-scss helm-company helm-c-yasnippet helm-ag haskell-snippets gruvbox-theme groovy-mode groovy-imports graphviz-dot-mode gradle-mode google-translate google-c-style golden-ratio godoctor go-tag go-rename go-impl go-guru go-gen-test go-fill-struct go-eldoc gnuplot gitignore-templates github-search github-clone gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe git-gutter-fringe+ gist gh-md geiser geeknote fuzzy font-lock+ flycheck-ycmd flycheck-rust flycheck-rtags flycheck-pos-tip flycheck-ocaml flycheck-nim flycheck-mix flycheck-ledger flycheck-haskell flycheck-elm flycheck-crystal flycheck-credo flycheck-bashate flx-ido fish-mode fill-column-indicator fasd fancy-battery eyebrowse expand-region evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-snipe evil-org evil-numbers evil-mc evil-matchit evil-magit evil-lisp-state evil-lion evil-ledger evil-indent-plus evil-iedit-state evil-goggles evil-exchange evil-escape evil-ediff evil-commentary evil-cleverparens evil-args evil-anzu eval-sexp-fu ess-R-data-view eshell-z eshell-prompt-extras esh-help erlang ensime emmet-mode elm-test-runner elm-mode elisp-slime-nav elfeed-web elfeed-org elfeed-goodies ein editorconfig dumb-jump dotenv-mode doom-themes doom-modeline disaster diminish diff-hl deft define-word darktooth-theme dactyl-mode cython-mode csv-mode cquery counsel-projectile company-ycmd company-web company-tern company-statistics company-shell company-rtags company-restclient company-lsp company-jedi company-irony company-go company-ghci company-emacs-eclim company-coq company-cabal company-c-headers company-auctex company-anaconda common-lisp-snippets column-enforce-mode cmm-mode clean-aindent-mode clang-format centered-cursor-mode ccls cargo browse-at-remote bm beacon auto-yasnippet auto-highlight-symbol auto-complete-rst auto-compile auctex-latexmk atom-one-dark-theme ameba alchemist aggressive-indent adoc-mode ace-link ace-jump-helm-line ac-ispell))))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
